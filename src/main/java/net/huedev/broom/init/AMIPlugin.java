...
public class AMIPlugin implements ModPluginProvider {
    ...
    public void onAMIHelpersAvailable(AMIHelpers amiHelpers) {
        ...
        itemBlacklist.addItemToBlacklist(new ItemStack(Block.WOOL));
        itemBlacklist.addItemToBlacklist(new ItemStack(Block.WOOL, 1, 1));
        itemBlacklist.addItemToBlacklist(new ItemStack(Block.WOOL, 1, 2));
        itemBlacklist.addItemToBlacklist(new ItemStack(Block.WOOL, 1, 3));
        itemBlacklist.addItemToBlacklist(new ItemStack(Block.WOOL, 1, 4));
        itemBlacklist.addItemToBlacklist(new ItemStack(Block.WOOL, 1, 5));
        itemBlacklist.addItemToBlacklist(new ItemStack(Block.WOOL, 1, 6));
        itemBlacklist.addItemToBlacklist(new ItemStack(Block.WOOL, 1, 7));
        itemBlacklist.addItemToBlacklist(new ItemStack(Block.WOOL, 1, 8));
        itemBlacklist.addItemToBlacklist(new ItemStack(Block.WOOL, 1, 9));
        itemBlacklist.addItemToBlacklist(new ItemStack(Block.WOOL, 1, 10));
        itemBlacklist.addItemToBlacklist(new ItemStack(Block.WOOL, 1, 11));
        itemBlacklist.addItemToBlacklist(new ItemStack(Block.WOOL, 1, 12));
        itemBlacklist.addItemToBlacklist(new ItemStack(Block.WOOL, 1, 13));
        itemBlacklist.addItemToBlacklist(new ItemStack(Block.WOOL, 1, 14));
        itemBlacklist.addItemToBlacklist(new ItemStack(Block.WOOL, 1, 15));
        ...
        itemBlacklist.addItemToBlacklist(new ItemStack(BroomBlocks.STONE_BRICK_DOUBLE_SLAB));
