...
public class FloodFillSearch {
    ...
    public int search(World world, int x, int y, int z, Function<BlockState, Boolean> criteria, Function<BlockState, Boolean> filter) {
        ...
        while (!starts.isEmpty()) {
            ...
            for (int pos : starts) {
                ...
                for (byte i = 0; i < 6; i++) {
                    ...
                    BlockState state = world.getBlockState(x + px, y + py, z + pz);
    ...
    public void transform(World world, int x, int y, int z, Function<BlockState, Boolean> criteria, Function<BlockState, BlockState> transformer) {
        IntList starts = buffers.get(0);
